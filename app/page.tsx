...
const services = [
  {
    ...
    desc: "SEO-optimiert, schnell & mobil. Gefunden werden bei Google – individuell für Ihr Unternehmen.",
    badge: "Paket 1",
  },
  {
    icon: (
    ...
    title: "KI-Chatbot",
    desc: "24/7 automatisch Kundenanfragen beantworten, Leads qualifizieren und Termine buchen.",
    badge: "Paket 2",
  },
  {
    icon: (
    ...
    desc: "Website + KI-Chatbot + WhatsApp-Marketing – alles aus einer Hand. Bestes Preis-Leistungs-Verhältnis.",
    badge: "Empfohlen ⭐",
  },
];
            ...
            {services.map(({ icon, title, desc, badge }) => (
              ...
              >
                <div className="flex items-start justify-between mb-5">
                  <div className="w-12 h-12 bg-blue-50 group-hover:bg-blue-700 rounded-xl flex items-center justify-center transition-colors duration-300 text-blue-700 group-hover:text-white">
                    {icon}
                  </div>
                ...
                <div className="mt-5 pt-5 border-t border-slate-100">
                  <span className="text-slate-400 text-sm font-medium">Preis auf Anfrage →</span>
                </div>
              </div>
            ))}
          </div>

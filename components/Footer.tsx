    ...
    <footer className="bg-slate-900 text-slate-400">
      <div className="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed mb-5">
            ...
            KI-Automatisierung für lokale Unternehmen<br />
            in Bielefeld & OWL.
          </p>
          <a
        ...
        {/* Contact & Legal */}
        <div>
          <h4 className="text-white font-semibold mb-4 text-sm uppercase tracking-wider">Kontakt & Recht</h4>
          <div className="text-sm space-y-2 mb-5">
            ...
            <a href="mailto:KundenPilot@gmail.com" className="hover:text-white transition-colors block">
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs">
          <p>© {new Date().getFullYear()} Kundenpilot. Alle Rechte vorbehalten.</p>
